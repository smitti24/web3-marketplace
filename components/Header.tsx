    ...
    <div className="max-w-6xl mx-auto p-2">
      <nav className="flex justify-between">
        ...
        <div className="flex items-center space-x-4 text-sm">
          ...
          <Link className="flex items-center hover:link" href="/addItem">Watchlist
          <ChevronDownIcon className="px-2 h-4"></ChevronDownIcon></Link>
      ...
      <section className="flex space-x-2 py-5 items-center">
        ...
        <div className="flex items-center space-x-2 px-2 md:px-5 py-2 border-white border-2 flex-1">
            ...
            <input className="bg-transparent flex-1 outline-none" type="text" placeholder="search for anuthing"></input>
        </div>

        <button className="button-main hidden sm:inline px-5 py-2 hover:scale-110 duration-300">Search</button>

<Link href="/create">
<button className="button-main hidden sm:inline px-5 py-2 hover:scale-110 duration-300">List Item</button>
</Link>
      ...
      <section className="flex justify-center space-x-4 items-center px-6 py-5 whitespace-nowrap">
        <p>Home</p>
        <p>Electronics</p>
        <p>Computers</p>
        <p>Video Games</p>
